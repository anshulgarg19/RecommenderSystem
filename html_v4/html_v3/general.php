<?php
    ...
    $DB_username = 'root';
    $DB_password = 'thisisubuntu';
    $DB_hostname = 'localhost';
    $DB_DB = 'movieLens';
    $DB_port = '1433';
	
    $project_title = 'Movie Recommender System';	
    $project_subtitle = 'Developed by Anshul Garg & Pulkit Aggarwal.';
    ...
    <!--<div class='well well-small' id='movie-<?php //print $movieid; ?>' >
    ...
    <?php //} ?>                       
                            ...
                            <?php /*
                                ...
                                $hide_goodrec_status = '';
                                $hide_badrec_status = '';
                                if (!isset($_SESSION['user'] && !$data['rated']){  
    ...
    function get_number_of_movies($search)
    {
        ...
        $sql = "SELECT COUNT(*) from movieList " . $SQL_FILTER;
