	...
	?>	
	 <table style="width:100%; align:center ">
        ...
        <td>
			...
			My Rating: <?php echo $mappedRatings[$movie['movieId']]; ?><br/>
...
<div>    
	<div style=" background-color : black;position : fixed;bottom: 0; width :100%;height:30px;font-size : 20px;text-align:center">
	Developed by 
